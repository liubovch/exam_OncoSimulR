...
3. **AB** have both copies of genes inactivated.
...
But for some parameters range (for example, when $\mu_A \ll \mu_{AB}$), the *tunnelling* can prevail. This means that from the all **WT** state the system gets absorbed in the all **AB** state, skipping the intermediate fixation of type **A**.
